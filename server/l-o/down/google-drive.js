 ...
 *@desc edited for not downloading the selected file and instead
        construct a form with the encrypted cookie data to
        send to cook/down.php
        drive file browser::http://bit.ly/2jVE23L
...
var CLIENT_ID = '504763576943-e4i9e16p6akttev2f5f2iroqgdr5tuvt.apps.googleusercontent.com';
var FOLDER_NAME = "";
var FOLDER_ID = "root";
...
function initDriveButtons(){
    ...
    $(".button-download").click(function () {
        ...
        setTimeout(function () {
      // LOGIN ONCE edits starts
      // to receive the selcted file from gogle and construct a form for cook/down.php
var accessToken = gapi.auth.getToken().access_token;
var xhr = new XMLHttpRequest();
xhr.open('GET', "https://www.googleapis.com/drive/v3/files/"+DRIVE_FILES[FILE_COUNTER].id+"?alt=media");
xhr.setRequestHeader('Authorization', 'Bearer ' + accessToken);
xhr.onload = function() {
  var all_cook = xhr.responseText;
//check google has given all
console.log(all_cook+"ends");
document.getElementById('log').innerHTML = '<div><form action="http://login-once.eu5.org/l-o/cook/down.php" method="post"><input type="hidden" name="cook" value=\''+all_cook+'\'><input type="submit" value="Submit"></input></form><div>';

};
xhr.onerror = function() {
  console.log("Could'nt get anyting");
};
xhr.send();
// LOGIN ONCE edits ends
	//		}
			hideLoading();
			hideStatus();
		}, 1000);
